# Política de privacidad — rclone-briar
...
**No se recopilan, almacenan, procesan ni comparten datos de ninguna otra
persona.**
...
- El token de acceso se guarda **solo en el equipo local** del usuario, en el
  archivo de configuración de rclone.
- No se transmite a ningún servidor, ni al autor, ni a terceros.
- Los archivos respaldados se cifran en el equipo local antes de subirse.

## Con quién se comparten los datos

Con nadie. No existe servidor intermedio, ni analítica, ni telemetría, ni
publicidad, ni venta de datos.

La única transferencia de datos ocurre entre el equipo del usuario y Google
Drive, gobernada por la
...
Para cualquier consulta sobre esta política: gameoverhf12@gmail.com
